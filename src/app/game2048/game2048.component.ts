...
export class Game2048Component implements OnInit {
  ...
  filterEmptyElem(next: any, act: any): any {
    this.repeat = false;
    for (let y = 0; y < 4; y++) {
      for (let x = 0; x < 4; x++) {
  ...
  filterEmptyElemReverse(next: any, act: any): any {
    this.repeat = false;
    for (let y = 3; y >= 0; y--) {
      for (let x = 3; x >= 0; x--) {
        this.filterElem(y, x, next, act);
  ...
  filterElem(y: any, x: any, next: any, act: any): any {
  ...
  cellTransition(y: any, x: any, next: any, cell: any): any {
  ...
  cellConnect(y: any, x: any, next: any, cell: any): any {
